...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      ...
      {answer: '(생각해보면 다행이야, 나는 내가 어떤 사람이 되고 싶은지<br>이야기할 수 있으니까)'}
    ]
  },
  {
  ...
  },
  {
    ...
    a: [
      ...
      {answer: '주변에는 제가 좋은 사람이 되기에는 각박하게 만드는<br>사람들이 더 많아요.'}
    ]
  },
  {
  ...
  },
  {
    ...
    a: [
      ...
      {answer: '친구는 좀 다른 것 같아요. 실질적으로 도움이 되고 안되고는<br>친구사이에 상관없죠.'}
    ]
  },
  {
  ...
  },
  {
    ...
    a: [
      {answer: '(그런 사람 보면 솔직히 가끔 가식이라는 생각도 들던데, 원하는<br>게 따로 있지 않나?)'},
  ...
  },
  {
    ...
    a: [
      {answer: '(돈, 법, 질서 모두 나를 지킬 수 있는 무기잖아? 그런 면에서<br>당연히 필요하지!)'},
